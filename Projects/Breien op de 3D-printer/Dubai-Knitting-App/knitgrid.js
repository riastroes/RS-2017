...
Knitgrid.prototype.disorderRadiusIn= function(vector, radius,  force){
    var dis;
    var distance = 0;
   ...
   for(var s = 0; s <= this.kstitches ; s++){
     for(var r = 0; r <= this.krows ; r++){
        ...
        distance = dist(vector.x, vector.y,this.grid[s][r].x, this.grid[s][r].y);
  ...
  Knitgrid.prototype.disorderRadiusOut= function(vector, radius,  force){
    var dis;
    var distance = 0;
  ...
  Knitgrid.prototype.disorderSin= function(vector, radius, force){
    var dis;
    var distance = 0;
    var a = 0;
  ...
  Knitgrid.prototype.disorderCos= function(vector, radius, force){
    var dis;
    var distance = 0;
    var a = 0;
...
Knitgrid.prototype.disorderVert= function(vector, force){
   ...
   for(var s = 0; s <= this.kstitches ; s++){
     for(var r = 0; r <= this.krows ; r++){
        ...
        distance = abs(vector.x-this.grid[s][r].x);
...
Knitgrid.prototype.disorderHor= function(vector, force){
    var dis;
    var distance = 0;
    var a = 0;
   ...
   for(var s = 0; s <= this.kstitches ; s++){
     for(var r = 0; r <= this.krows ; r++){
        ...
        distance = abs(vector.y - this.grid[s][r].y);
