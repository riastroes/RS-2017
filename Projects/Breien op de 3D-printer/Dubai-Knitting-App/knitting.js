...
Knitting.prototype.gotoStart = function(pos, offset){
      ...
      lastp.z =0;
       ...
       lastp = lastp.copy();
       lastp.x =( this.biggrid.grid[pos.x][pos.y].x * newscale) - (40 * newscale);
       lastp.z =0;
       point(lastp.x + offset.x, lastp.y + offset.y);
       append(this.layer.p, lastp);
       lastp = lastp.copy();
       ...
       point((this.biggrid.grid[pos.x][pos.y].x * newscale)  + offset.x,(this.biggrid.grid[pos.x][pos.y].y *newscale) + offset.y);
       append(this.layer.p, createVector(this.biggrid.grid[pos.x][pos.y].x * newscale,this.biggrid.grid[pos.x][pos.y].y * newscale,0));
